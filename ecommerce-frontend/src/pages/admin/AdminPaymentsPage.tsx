            ...
            <tbody>
              {paymentList.map((payment) => (
                <tr key={payment.id} className="border-b border-border last:border-0">
                  <td className="px-4 py-3 font-mono text-xs text-muted">{payment.id.slice(0, 8)}</td>
                  <td className="px-4 py-3 font-mono text-xs text-muted">{payment.order_id.slice(0, 8)}</td>
